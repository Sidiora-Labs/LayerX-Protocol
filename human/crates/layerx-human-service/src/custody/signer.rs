...
impl Operation {
    ...
    #[must_use]
    pub const fn from_label(value: &str) -> Option<Self> {
        match value {
...
impl CustodySigner {
    ...
    pub fn bind_authenticated_step_up(
        ...
        passkeys.revalidate_step_up(scope, authenticated, expected_auth_operation, now)
        ...
        StepUpEvidence::new(evidence_id, operation, prepared_disclosure_digest,
            authenticated.completed_at(), authenticated.expires_at())
    }
