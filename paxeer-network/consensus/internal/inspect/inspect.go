...
import (
	...
	"github.com/sidiora-labs/paxeer-network/consensus/internal/inspect/rpc"
	...
	"github.com/sidiora-labs/paxeer-network/consensus/internal/state/indexer/sink"
...
var logger = paxlog.NewLogger("tendermint", "internal", "inspect")
