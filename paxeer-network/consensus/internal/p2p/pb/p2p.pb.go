...
type Handshake struct {
	...
	PaxGigaConnection bool     `protobuf:"varint,3,opt,name=pax_giga_connection,json=paxGigaConnection,proto3" json:"pax_giga_connection,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Handshake) GetPaxGigaConnection() bool {
	if x != nil {
		return x.PaxGigaConnection
	}
	return false
}
