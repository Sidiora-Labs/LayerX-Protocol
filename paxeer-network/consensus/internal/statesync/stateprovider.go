...
import (
	...
	lightprovider "github.com/sidiora-labs/paxeer-network/consensus/light/provider"
	lighthttp "github.com/sidiora-labs/paxeer-network/consensus/light/provider/http"
	lightrpc "github.com/sidiora-labs/paxeer-network/consensus/light/rpc"
	lightdb "github.com/sidiora-labs/paxeer-network/consensus/light/store/db"
...
var logger = paxlog.NewLogger("tendermint", "internal", "statesync")
