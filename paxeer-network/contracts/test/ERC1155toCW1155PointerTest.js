...
describe("ERC1155 to CW1155 Pointer", function () {
    ...
    before(async function () {
        ...
        cw1155Address = await deployWasm(WASM.CW1155, admin.paxAddress, "cw1155", {
            name: "Test",
            symbol: "TEST",
            minter: admin.paxAddress
        })

        await executeWasm(cw1155Address, {mint: {recipient: admin.paxAddress, msg: {token_id: "1", amount: "10", token_uri: "uri1"}}});
        await executeWasm(cw1155Address, {mint: {recipient: accounts[0].paxAddress, msg: {token_id: "1", amount: "11"}}});
        await executeWasm(cw1155Address, {mint: {recipient: accounts[1].paxAddress, msg: {token_id: "2", amount: "12", token_uri: "uri2"}}});
        await executeWasm(cw1155Address, {mint: {recipient: admin.paxAddress, msg: {token_id: "2", amount: "13"}}});
        await executeWasm(cw1155Address, {mint: {recipient: accounts[1].paxAddress, msg: {token_id: "3", amount: "14", token_uri: "uri3"}}});
