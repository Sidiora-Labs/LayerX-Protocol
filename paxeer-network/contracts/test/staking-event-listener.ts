...
async function main() {
  console.log("🎧 Starting Pax Staking Event Listener...\n");
  ...
  console.log("📡 Connected to Pax EVM RPC at http://localhost:8545");
  console.log(
            ...
            try {
              ...
              switch (decodedEvent.eventName) {
                case "Delegate":
                  ...
                  console.log("  Amount:", formatEther(args.amount), "PAX");
                  break;
