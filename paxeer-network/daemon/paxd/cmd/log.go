...
func logLevelSubCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Query and modify logger levels on a running paxd node via the admin gRPC service.",
	}
...
Pattern can be an exact logger name (e.g. "modules/evm/state"), a glob
pattern (e.g. "modules/evm/*"), or "*" to set all loggers.
