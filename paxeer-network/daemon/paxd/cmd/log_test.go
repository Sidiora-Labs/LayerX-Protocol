...
func TestLogLevelSet_Integration(t *testing.T) {
	_ = paxlog.NewLogger("cli-set-test")
	...
	lvl, ok := paxlog.GetLevel("cli-set-test")
	require.True(t, ok)
	require.Equal(t, slog.LevelError, lvl)
}

func TestLogLevelGet_Integration(t *testing.T) {
	_ = paxlog.NewLogger("cli-get-test")
	paxlog.SetLevel("cli-get-test", slog.LevelWarn)
	addr, cleanup := startTestAdminServer(t)
	defer cleanup()
...
func TestLogLevelList_Integration(t *testing.T) {
	_ = paxlog.NewLogger("cli-list-test")
	addr, cleanup := startTestAdminServer(t)
	defer cleanup()
...
func TestLogLevelList_WithPrefix_Integration(t *testing.T) {
	_ = paxlog.NewLogger("cli-pfx", "child1")
	_ = paxlog.NewLogger("cli-pfx", "child2")
	_ = paxlog.NewLogger("cli-other-logger")
	addr, cleanup := startTestAdminServer(t)
	defer cleanup()
...
func TestLogLevelSet_ThenGet_Integration(t *testing.T) {
	_ = paxlog.NewLogger("cli-roundtrip")
	addr, cleanup := startTestAdminServer(t)
	defer cleanup()
