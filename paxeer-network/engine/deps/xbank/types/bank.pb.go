...
type Input struct {
	...
	Coins   github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/sidiora-labs/paxeer-network/sdk/types.Coins" json:"coins"`
}
...
type Supply struct {
	Total github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/sidiora-labs/paxeer-network/sdk/types.Coins" json:"total"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "paxprotocol.pax-chain.gigabank.Params")
	proto.RegisterType((*SendEnabled)(nil), "paxprotocol.pax-chain.gigabank.SendEnabled")
	proto.RegisterType((*Input)(nil), "paxprotocol.pax-chain.gigabank.Input")
	proto.RegisterType((*Output)(nil), "paxprotocol.pax-chain.gigabank.Output")
	proto.RegisterType((*Supply)(nil), "paxprotocol.pax-chain.gigabank.Supply")
	proto.RegisterType((*DenomUnit)(nil), "paxprotocol.pax-chain.gigabank.DenomUnit")
	proto.RegisterType((*Metadata)(nil), "paxprotocol.pax-chain.gigabank.Metadata")
	proto.RegisterType((*AllowList)(nil), "paxprotocol.pax-chain.gigabank.AllowList")
}
