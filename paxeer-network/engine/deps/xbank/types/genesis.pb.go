...
type GenesisState struct {
	...
	Supply github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=supply,proto3,castrepeated=github.com/sidiora-labs/paxeer-network/sdk/types.Coins" json:"supply"`
...
type WeiBalance struct {
	...
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// wei balance amount.
	Amount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Int" json:"amount"`
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "paxprotocol.pax-chain.gigabank.GenesisState")
	proto.RegisterType((*Balance)(nil), "paxprotocol.pax-chain.gigabank.Balance")
	proto.RegisterType((*WeiBalance)(nil), "paxprotocol.pax-chain.gigabank.WeiBalance")
}
