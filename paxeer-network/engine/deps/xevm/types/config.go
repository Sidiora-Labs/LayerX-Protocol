...
case on Pax for all versions up to Cancun. Still, we want to keep these fields in the
config for backward compatibility with the official EVM lib.
*/
func (cc ChainConfig) EthereumConfig(chainID *big.Int) *params.ChainConfig {
	return &params.ChainConfig{
		ChainID:                chainID,
		PaxSstoreSetGasEIP2200: func() *uint64 { u := cc.PaxSstoreSetGasEip2200; return &u }(),
		HomesteadBlock:         utils.Big0,
		DAOForkBlock:           utils.Big0,
		DAOForkSupport:         false, // fork of Pax is supported outside EVM
...
func (cc ChainConfig) EthereumConfigWithSstore(chainID *big.Int, sstoreSetGasEIP2200 *uint64) *params.ChainConfig {
	...
	cfg.PaxSstoreSetGasEIP2200 = sstoreSetGasEIP2200
	return cfg
}
