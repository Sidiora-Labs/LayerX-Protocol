...
type Params struct {
	...
	// ];
	PriorityNormalizer github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=priority_normalizer,json=priorityNormalizer,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Dec" json:"priority_normalizer" yaml:"priority_normalizer"`
	BaseFeePerGas      github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=base_fee_per_gas,json=baseFeePerGas,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Dec" json:"base_fee_per_gas" yaml:"base_fee_per_gas"`
	MinimumFeePerGas   github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=minimum_fee_per_gas,json=minimumFeePerGas,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Dec" json:"minimum_fee_per_gas" yaml:"minimum_fee_per_gas"`
	...
	MaxDynamicBaseFeeDownwardAdjustment    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,11,opt,name=max_dynamic_base_fee_downward_adjustment,json=maxDynamicBaseFeeDownwardAdjustment,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Dec" json:"max_dynamic_base_fee_downward_adjustment" yaml:"max_dynamic_base_fee_downward_adjustment"`
	...
	MaximumFeePerGas                       github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,13,opt,name=maximum_fee_per_gas,json=maximumFeePerGas,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Dec" json:"maximum_fee_per_gas" yaml:"maximum_fee_per_gas"`
...
func init() {
	proto.RegisterType((*Params)(nil), "paxprotocol.paxchain.gigaevm.Params")
	proto.RegisterType((*ParamsPreV580)(nil), "paxprotocol.paxchain.gigaevm.ParamsPreV580")
	proto.RegisterType((*ParamsPreV600)(nil), "paxprotocol.paxchain.gigaevm.ParamsPreV600")
	proto.RegisterType((*ParamsPreV601)(nil), "paxprotocol.paxchain.gigaevm.ParamsPreV601")
	proto.RegisterType((*ParamsPreV606)(nil), "paxprotocol.paxchain.gigaevm.ParamsPreV606")
}
