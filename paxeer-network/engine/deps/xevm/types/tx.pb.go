...
import (
	...
	github_com_pax_protocol_pax_chain_x_evm_derived "github.com/sidiora-labs/paxeer-network/engine/deps/xevm/derived"
...
type MsgEVMTransaction struct {
	...
	Derived *github_com_pax_protocol_pax_chain_x_evm_derived.Derived `protobuf:"bytes,2,opt,name=derived,proto3,customtype=github.com/sidiora-labs/paxeer-network/engine/deps/xevm/derived.Derived" json:"derived,omitempty"`
}
...
type MsgInternalEVMCall struct {
	...
	Value  *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=value,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Int" json:"value,omitempty"`
...
type MsgSend struct {
	...
	Amount      github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/sidiora-labs/paxeer-network/sdk/types.Coins" json:"amount"`
}
...
type MsgRegisterPointer struct {
	Sender      string      `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	PointerType PointerType `protobuf:"varint,2,opt,name=pointer_type,json=pointerType,proto3,enum=paxprotocol.paxchain.gigaevm.PointerType" json:"pointer_type,omitempty"`
...
type Asset struct {
	AssetType       AssetType `protobuf:"varint,1,opt,name=asset_type,json=assetType,proto3,enum=paxprotocol.paxchain.gigaevm.AssetType" json:"asset_type,omitempty"`
...
func init() {
	proto.RegisterType((*MsgEVMTransaction)(nil), "paxprotocol.paxchain.gigaevm.MsgEVMTransaction")
	proto.RegisterType((*MsgEVMTransactionResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgEVMTransactionResponse")
	proto.RegisterType((*MsgInternalEVMCall)(nil), "paxprotocol.paxchain.gigaevm.MsgInternalEVMCall")
	proto.RegisterType((*MsgInternalEVMCallResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgInternalEVMCallResponse")
	proto.RegisterType((*MsgInternalEVMDelegateCall)(nil), "paxprotocol.paxchain.gigaevm.MsgInternalEVMDelegateCall")
	proto.RegisterType((*MsgInternalEVMDelegateCallResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgInternalEVMDelegateCallResponse")
	proto.RegisterType((*MsgSend)(nil), "paxprotocol.paxchain.gigaevm.MsgSend")
	proto.RegisterType((*MsgSendResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgSendResponse")
	proto.RegisterType((*MsgRegisterPointer)(nil), "paxprotocol.paxchain.gigaevm.MsgRegisterPointer")
	proto.RegisterType((*MsgRegisterPointerResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgRegisterPointerResponse")
	proto.RegisterType((*MsgAssociateContractAddress)(nil), "paxprotocol.paxchain.gigaevm.MsgAssociateContractAddress")
	proto.RegisterType((*MsgAssociateContractAddressResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgAssociateContractAddressResponse")
	proto.RegisterType((*MsgAssociate)(nil), "paxprotocol.paxchain.gigaevm.MsgAssociate")
	proto.RegisterType((*MsgAssociateResponse)(nil), "paxprotocol.paxchain.gigaevm.MsgAssociateResponse")
	proto.RegisterType((*MsgClaim)(nil), "paxprotocol.paxchain.gigaevm.MsgClaim")
	proto.RegisterType((*Asset)(nil), "paxprotocol.paxchain.gigaevm.Asset")
	proto.RegisterType((*MsgClaimSpecific)(nil), "paxprotocol.paxchain.gigaevm.MsgClaimSpecific")
}
...
func (c *msgClient) EVMTransaction(ctx context.Context, in *MsgEVMTransaction, opts ...grpc.CallOption) (*MsgEVMTransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/paxprotocol.paxchain.gigaevm.Msg/EVMTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Send(ctx context.Context, in *MsgSend, opts ...grpc.CallOption) (*MsgSendResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/paxprotocol.paxchain.gigaevm.Msg/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RegisterPointer(ctx context.Context, in *MsgRegisterPointer, opts ...grpc.CallOption) (*MsgRegisterPointerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/paxprotocol.paxchain.gigaevm.Msg/RegisterPointer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AssociateContractAddress(ctx context.Context, in *MsgAssociateContractAddress, opts ...grpc.CallOption) (*MsgAssociateContractAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/paxprotocol.paxchain.gigaevm.Msg/AssociateContractAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Associate(ctx context.Context, in *MsgAssociate, opts ...grpc.CallOption) (*MsgAssociateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/paxprotocol.paxchain.gigaevm.Msg/Associate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EVMTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paxprotocol.paxchain.gigaevm.Msg/EVMTransaction",
	}
...
func _Msg_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paxprotocol.paxchain.gigaevm.Msg/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RegisterPointer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paxprotocol.paxchain.gigaevm.Msg/RegisterPointer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AssociateContractAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paxprotocol.paxchain.gigaevm.Msg/AssociateContractAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Associate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paxprotocol.paxchain.gigaevm.Msg/Associate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "paxprotocol.paxchain.gigaevm.Msg",
...
func (m *MsgEVMTransaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_pax_protocol_pax_chain_x_evm_derived.Derived
			m.Derived = &v
