...
type DeferredInfo struct {
	...
	Surplus github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=surplus,proto3,customtype=github.com/sidiora-labs/paxeer-network/sdk/types.Int" json:"surplus"`
...
func init() {
	proto.RegisterType((*Whitelist)(nil), "paxprotocol.paxchain.gigaevm.Whitelist")
	proto.RegisterType((*DeferredInfo)(nil), "paxprotocol.paxchain.gigaevm.DeferredInfo")
}
