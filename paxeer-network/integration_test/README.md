...
There's a template yaml file which you can copy from to start with: [template](https://github.com/sidiora-labs/paxeer-network/tree/main/integration_test/template/template_test.yaml)
