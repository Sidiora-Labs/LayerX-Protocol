...
const { fundAddress, getPaxAddress, execute } = require("../../../contracts/test/lib.js");
...
describe("NFT Marketplace", function () {
    ...
    let marketplace, deployer, erc721token, erc721PointerToken, cw721Address, originalPaxdConfig;
    ...
    before(async function () {
        ...
        const cw721Details = await deployCw721WithPointer(deployerPaxAddr, deployer, time, evmRpcUrls[testChain])
        ...
        for (let i = 1; i <= numCwNftsToMint; i++) {
            await mintCw721(cw721Address, deployerPaxAddr, i)
        }
