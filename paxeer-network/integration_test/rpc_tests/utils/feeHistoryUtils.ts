...
import { Eip1559Params, nextBaseFeePax, nextBaseFeeGeth, blockGasInfo } from './chainUtils';
...
export async function verifyFeeHistorySeries(
    ...
    // Pax reports gasUsedRatio quantized to 4 decimal places; geth is full precision.
    const ratioTol = chain === 'pax' ? 1.01e-4 : 1e-9;
