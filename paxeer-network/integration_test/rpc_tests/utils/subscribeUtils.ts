...
/** Every field Pax pushes in an eth_newHeads notification (rpc/subscribe.go encodeCommittedBlock). */
...
/** The PoW/PoS-only header fields Pax cannot populate must be their canonical zero values. */
