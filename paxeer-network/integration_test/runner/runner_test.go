...
func TestPaxDB(t *testing.T) {
	runner.RunFile(t, "../paxdb/flatkv_evm_test.yaml")
	runner.RunFile(t, "../paxdb/state_store_test.yaml")
}
...
// TestStateSync requires the pax-rpc-node container, which is only present in
