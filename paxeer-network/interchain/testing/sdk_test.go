...
import (
	...
	authcli "github.com/sidiora-labs/paxeer-network/sdk/x/auth/client/cli"
	...
	ibcclientcli "github.com/sidiora-labs/paxeer-network/interchain/modules/core/02-client/client/cli"
	"github.com/sidiora-labs/paxeer-network/interchain/testing/simapp"
	"github.com/sidiora-labs/paxeer-network/interchain/testing/simapp/params"
)
...
func TestIntegrationTestSuite(t *testing.T) {
	//TODO: these integration tests suite are broken on pax-cosmos old version as well, but working in monorepo, so we'll need to fix them once merging into monorepo
