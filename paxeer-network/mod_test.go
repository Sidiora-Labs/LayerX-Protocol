...
// bannedUpstream lists original upstream modules that pax has forked into local
...
// reference original upstream modules that pax has forked.
//
...
// for original upstream modules that pax has forked.
