...
const (
	...
	GetPaxAddressType              EVMQueryType = "evm_query_get_pax_address"
	SupportsInterfaceType          EVMQueryType = "evm_query_supports_interface"
)

func (q *PaxEVMQuery) GetQueryType() EVMQueryType {
	if q.StaticCall != nil {
	...
	if q.GetPaxAddress != nil {
		return GetPaxAddressType
	}
...
type PaxEVMQuery struct {
	...
	GetPaxAddress                *GetPaxAddressRequest                `json:"get_pax_address,omitempty"`
...
type GetEvmAddressRequest struct {
	PaxAddress string `json:"pax_address"`
}

type GetPaxAddressRequest struct {
...
type GetPaxAddressResponse struct {
	PaxAddress string `json:"pax_address"`
	Associated bool   `json:"associated"`
}
