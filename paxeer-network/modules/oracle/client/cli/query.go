...
func GetCmdQueryExchangeRates() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Query the current Pax exchange rate w.r.t an asset",
		Long: strings.TrimSpace(`
Query the current exchange rate of Pax with an asset.
...
$ paxd query oracle exchange-rates ukrw
`),
...
$ paxd query oracle price-snapshot-history
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
func GetCmdQueryActives() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "actives",
		Args:  cobra.NoArgs,
		Short: "Query the active list of Pax assets recognized by the oracle",
		Long: strings.TrimSpace(`
Query the active list of Pax assets recognized by the types.

$ paxd query oracle actives
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ paxd query oracle feeder terravaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ paxd query oracle miss paxvaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
