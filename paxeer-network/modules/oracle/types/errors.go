...
var (
	...
	ErrParsingOracleQuery    = sdkerrors.Register(ModuleName, 18, "Error parsing PaxOracleQuery")
	...
	ErrUnknownPaxOracleQuery = sdkerrors.Register(ModuleName, 23, "Error unknown pax oracle query")
