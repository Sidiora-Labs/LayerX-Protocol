...
var (
	...
	ErrParsingPaxTokenFactoryQuery    = sdkerrors.Register(ModuleName, 15, "Error parsing PaxTokenFactoryQuery")
	...
	ErrUnknownPaxTokenFactoryQuery    = sdkerrors.Register(ModuleName, 23, "Error unknown pax token factory query")
