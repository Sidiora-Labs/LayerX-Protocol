...
func (suite *OptimisticProcessingTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(false, tmproto.Header{Height: 1, ChainID: "pax-test"})
}
...
func (suite *OptimisticProcessingTestSuite) TestProcessProposalHandler_NewOptimisticProcessing() {
	...
	req := &abci.RequestProcessProposal{
		Hash:   []byte("test-hash"),
		Txs:    [][]byte{},
		Header: &tmproto.Header{Height: suite.ctx.BlockHeight(), ChainID: "pax-test"},
	}
...
func (suite *OptimisticProcessingTestSuite) TestProcessProposalHandler_UpgradePlanAborts() {
	...
	req := &abci.RequestProcessProposal{
		Hash:   []byte("test-hash"),
		Txs:    [][]byte{},
		Header: &tmproto.Header{Height: nextCtx.BlockHeight(), ChainID: "pax-test"},
	}
