...
type TestPaxDBAppOpts struct {
}

func (t TestPaxDBAppOpts) Get(s string) interface{} {
...
func TestNewDefaultConfig(t *testing.T) {
	// Make sure when adding a new default config, it should apply to PaxDB during initialization
	appOpts := TestPaxDBAppOpts{}
