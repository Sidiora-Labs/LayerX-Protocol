...
import (
	...
	cosmosante "github.com/sidiora-labs/paxeer-network/sdk/x/auth/ante"
...
var _ sdk.TxPrioritizer = (*PaxTxPrioritizer)(nil).GetTxPriorityHint

type PaxTxPrioritizer struct {
	evmKeeper     *evmkeeper.Keeper
	upgradeKeeper *upgradekeeper.Keeper
	paramsKeeper  *paramskeeper.Keeper
}

func NewPaxTxPrioritizer(ek *evmkeeper.Keeper, uk *upgradekeeper.Keeper, pk *paramskeeper.Keeper) *PaxTxPrioritizer {
	return &PaxTxPrioritizer{
		evmKeeper:     ek,
		upgradeKeeper: uk,
		paramsKeeper:  pk,
	}
...
func (s *PaxTxPrioritizer) GetTxPriorityHint(ctx sdk.Context, tx sdk.Tx) (_priorityHint int64, _err error) {
	defer func() {
		if r := recover(); r != nil {
...
func (s *PaxTxPrioritizer) getEvmTxPriority(ctx sdk.Context, evmTx *evmtypes.MsgEVMTransaction) (int64, error) {
...
func (s *PaxTxPrioritizer) getEvmBaseFee(ctx sdk.Context) *big.Int {
	const (
		pacific1              = "pacific-1"
...
func (s *PaxTxPrioritizer) getCosmosTxPriority(ctx sdk.Context, feeTx sdk.FeeTx) (int64, error) {
	if isOracleTx(feeTx) {
