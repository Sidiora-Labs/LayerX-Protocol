...
func TestEvmEventsForCw20(t *testing.T) {
	...
	amt := sdk.NewCoins(sdk.NewCoin("uhpx", sdk.NewInt(1000000000000)))
		...
		Events: []abci.Event{
			...
			},
			{
				...
				Attributes: []abci.EventAttribute{
					...
					{Key: []byte("sender"), Value: []byte("pax1n5n56lvfsda29hm38a2tn5pnf6nx84a38346yx")},
					{Key: []byte("recipient"), Value: []byte("pax1n5n56lvfsda29hm38a2tn5pnf6nx84a38346yx")},
					{Key: []byte("token_id"), Value: []byte("0")},
					{Key: []byte("action"), Value: []byte("transfer_nft")},
					{Key: []byte("sender"), Value: []byte("pax1xj2la8suyhfxjzdv3fc2w4upag32mc635fuj3q")},
					{Key: []byte("recipient"), Value: []byte("pax1xj2la8suyhfxjzdv3fc2w4upag32mc635fuj3q")},
