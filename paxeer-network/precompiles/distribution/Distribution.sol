...
interface IDistr {
    ...
    /// @dev The caller must have a valid associated Pax address
    ...
    /// @param validator The validator's Pax address (e.g., "paxvaloper1...")
    ...
    /// @param validators Array of validator Pax addresses
    ...
    struct Coin {
        ...
        uint256 decimals;
        /// @notice Token denomination (e.g., "uhpx", "uatom")
        string denom;
    }
    ...
    struct Reward {
        ...
        Coin[] coins;
        /// @notice The validator's Pax address that generated these rewards
