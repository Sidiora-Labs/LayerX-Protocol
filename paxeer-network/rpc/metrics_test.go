...
func TestClassifyRPCMetricError(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "pax_legacy", err: errPaxLegacyNotEnabledForTest("m"), wantClass: errorClassPaxLegacyDisabled, wantCode: jsonrpcCodeBucketSpec},
...
func errPaxLegacyNotEnabledForTest(method string) error {
	return &errPaxLegacyNotEnabled{method: method}
}
