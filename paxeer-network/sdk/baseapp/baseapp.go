...
import (
	...
	sdbm "github.com/paxeer-network/pax-tm-db/backends"
...
var (
	logger = paxlog.NewLogger("cosmos", "baseapp")
...
func NewBaseApp(
	...
	if app.ChainID == "" {
		panic("must pass --chain-id when calling 'paxd start' or set in ~/.pax/config/client.toml")
	}
	...
	for i, msg := range msgs {
		...
		if handler := app.msgServiceRouter.Handler(msg); handler != nil {
			...
			metrics.MeasureSinceWithLabels(
				[]string{"pax", "cosmos", "run", "msg", "latency"},
				startTime,
