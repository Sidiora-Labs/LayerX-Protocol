...
```
go get github.com/sidiora-labs/paxeer-network/sdk/cosmovisor/cmd/cosmovisor
```
...
app.UpgradeKeeper.SetUpgradeHandler("test1", func(ctx sdk.Context, plan upgradetypes.Plan) {
	...
	err = app.BankKeeper.AddCoins(ctx, addr, sdk.Coins{sdk.Coin{Denom: "uhpx", Amount: sdk.NewInt(345600000)}})
	if err != nil {
		panic(err)
	}
})
