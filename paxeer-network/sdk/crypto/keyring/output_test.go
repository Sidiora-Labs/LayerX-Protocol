...
func TestBech32KeysOutput(t *testing.T) {
	...
	require.Equal(t, `{Name:multisig Type:multi Address:pax1nf8lf6n4wa43rzmdzwe6hkrnw5guekhqhmcvtx EvmAddress: PubKey:{"@type":"/cosmos.crypto.multisig.LegacyAminoPubKey","threshold":1,"public_keys":[{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AurroA7jvfPd1AadmmOvWM2rJSwipXfRf8yD6pLbA2DJ"}]} Mnemonic:}`, fmt.Sprintf("%+v", out))
}
