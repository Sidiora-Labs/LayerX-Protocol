...
func TestNewPrivKeySecp256k1(t *testing.T) {
	...
	privKey, addr, err := NewPrivKeySecp256k1(path, "pax")
	require.NoError(t, err)
	require.NotNil(t, privKey)
	require.NotEmpty(t, addr)
	require.Contains(t, addr, "pax")
}
...
func TestShowAddress(t *testing.T) {
	...
	err = ShowAddress(path, privKey.PubKey(), "pax")
	require.NoError(t, err)
}
...
func TestShowAddress_Mismatch(t *testing.T) {
	...
	err = ShowAddress(path1, privKey2.PubKey(), "pax")
	require.Error(t, err)
