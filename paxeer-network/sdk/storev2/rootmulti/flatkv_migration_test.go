...
// storage/state_db/sc/composite/store_migration_test.go pin the same
...
// what a Pax node observes during the operator-driven migration and is
...
func migrationVersionInFlatKV(t *testing.T, dir string, cfg paxdbconfig.StateCommitConfig) (uint64, bool) {
	t.Helper()
