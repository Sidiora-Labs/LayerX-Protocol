...
func (c Context) PaxSenderAddress() AccAddress {
	return c.paxSenderAddress
}
...
func (c Context) WithPaxSenderAddress(address AccAddress) Context {
	c.paxSenderAddress = address
	return c
}
