...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/sidiora-labs/paxeer-network/sdk/types/errors.Wrap",
		"github.com/sidiora-labs/paxeer-network/sdk/types/errors.Wrapf",
		"github.com/sidiora-labs/paxeer-network/sdk/types/errors.WithType",
