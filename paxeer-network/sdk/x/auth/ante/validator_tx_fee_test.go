...
func TestGetTxPriority(t *testing.T) {
	...
	require.Equal(
		t,
		int64(1_000_000_000),
		ante.GetTxPriority(sdk.NewCoins(sdk.NewCoin("uhpx", sdk.NewInt(1))), 1000),
	)
	require.Equal(
		t,
		int64(0),
		ante.GetTxPriority(sdk.NewCoins(sdk.NewCoin("uhpx", sdk.NewInt(1))), 10_000_000_000_000), // gas too large
	)
}
