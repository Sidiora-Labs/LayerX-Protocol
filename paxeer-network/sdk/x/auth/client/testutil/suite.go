...
import (
	...
	bankcli "github.com/sidiora-labs/paxeer-network/sdk/x/bank/client/testutil"
...
func TestGetBroadcastCommandWithoutOfflineFlag(t *testing.T) {
	...
	require.NoError(t, err)
	err = builder.SetMsgs(banktypes.NewMsgSend(from, to, sdk.Coins{sdk.NewInt64Coin("uhpx", 10000)}))
	require.NoError(t, err)
