...
func (suite *IntegrationTestSuite) TestExportGenesis() {
	...
	expectedWeiBalances := []types.WeiBalance{
		{Amount: keeper.OneUhpxInWei.Sub(sdk.OneInt()), Address: expectedBalances[0].Address},
...
func (suite *IntegrationTestSuite) TestTotalSupply() {
	...
	balances := []types.Balance{
		{Coins: sdk.NewCoins(sdk.NewCoin("foocoin", sdk.NewInt(1))), Address: "pax10xwrnrezdg227cgt82az7f7j47q3zklvdh3g0l"},
		{Coins: sdk.NewCoins(sdk.NewCoin("barcoin", sdk.NewInt(1))), Address: "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"},
		{Coins: sdk.NewCoins(sdk.NewCoin("foocoin", sdk.NewInt(10)), sdk.NewCoin("barcoin", sdk.NewInt(20))), Address: "pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k"},
	}
	weiBalances := []types.WeiBalance{
		{Amount: sdk.OneInt(), Address: "pax10xwrnrezdg227cgt82az7f7j47q3zklvdh3g0l"},
		{Amount: keeper.OneUhpxInWei.Sub(sdk.OneInt()), Address: "pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k"},
	}
	...
	testcases := []struct {
	...
	}{
		{
			...
			nil, true, "genesis supply is incorrect, expected 1wrongcoin, got 21barcoin,11foocoin,1uhpx",
		},
		{
