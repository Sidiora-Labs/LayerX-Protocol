...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cosmos-sdk/MsgSend","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"pax1d9h8qat5tzjsw2","to_address":"pax1da6hgur4ws7grn8t"}}`
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cosmos-sdk/MsgMultiSend","value":{"inputs":[{"address":"pax1d9h8qat5tzjsw2","coins":[{"amount":"10","denom":"atom"}]}],"outputs":[{"address":"pax1da6hgur4ws7grn8t","coins":[{"amount":"10","denom":"atom"}]}]}}`
	require.Equal(t, expected, string(res))
}
...
func TestMsgSendSigners(t *testing.T) {
	signers := []sdk.AccAddress{
		sdk.MustAccAddressFromBech32("pax10xwrnrezdg227cgt82az7f7j47q3zklvdh3g0l"),
		sdk.MustAccAddressFromBech32("pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k"),
		sdk.MustAccAddressFromBech32("pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"),
	}
