...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.addrs = paxapp.AddTestAddrs(app, ctx, 2, sdk.NewInt(1000000000))
	suite.valAddrs = paxapp.ConvertAddrsToValAddrs(suite.addrs)
}
...
func (suite *KeeperTestSuite) TestGRPCValidatorOutstandingRewards() {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("uhpx", sdk.NewDec(300)),
	}
		...
		},
		{
			...
			func() {
				...
				expectedDelReward := types.NewDelegationDelegatorReward(valAddrs[0],
					sdk.DecCoins{sdk.NewInt64DecCoin("uhpx", 5)})
