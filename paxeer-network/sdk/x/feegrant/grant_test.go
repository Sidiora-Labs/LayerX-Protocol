...
func TestGrant(t *testing.T) {
	...
	addr, err := sdk.AccAddressFromBech32("pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t")
	require.NoError(t, err)
	addr2, err := sdk.AccAddressFromBech32("pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k")
	require.NoError(t, err)
