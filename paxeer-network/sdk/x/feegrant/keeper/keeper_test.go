...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.app = app
	suite.sdkCtx = ctx
	suite.addrs = paxapp.AddTestAddrsIncremental(app, ctx, 4, sdk.NewInt(30000000))
...
func (suite *KeeperTestSuite) TestKeeperCrud() {
	...
	accAddr, err := sdk.AccAddressFromBech32("pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k")
	suite.Require().NoError(err)
