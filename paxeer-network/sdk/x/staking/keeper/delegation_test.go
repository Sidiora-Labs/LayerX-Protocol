...
func TestSetDelegation(t *testing.T) {
	...
	addrDels := paxapp.AddTestAddrsIncremental(app, ctx, 3, sdk.NewInt(10000))
...
func TestDelegationGentx(t *testing.T) {
	...
	addrDels := paxapp.AddTestAddrsIncremental(app, ctx, 3, app.StakingKeeper.TokensFromConsensusPower(ctx, 5100000000000))
	valAddrs := paxapp.ConvertAddrsToValAddrs(addrDels)
...
func TestUnbondingDelegation(t *testing.T) {
	...
	delAddrs := paxapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(10000))
	valAddrs := paxapp.ConvertAddrsToValAddrs(delAddrs)
...
func TestUnbondDelegation(t *testing.T) {
	...
	delAddrs := paxapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
	valAddrs := paxapp.ConvertAddrsToValAddrs(delAddrs)
...
func TestUnbondingDelegationsMaxEntries(t *testing.T) {
	...
	addrDels := paxapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
...
func TestUndelegateFromUnbondingValidator(t *testing.T) {
	...
	addrDels := paxapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(0))
	addrVals := paxapp.ConvertAddrsToValAddrs(addrDels)
...
func TestRedelegateToSameValidator(t *testing.T) {
	...
	addrDels := paxapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(0))
	addrVals := paxapp.ConvertAddrsToValAddrs(addrDels)
