...
func TestNewQuerier(t *testing.T) {
	...
	addrs := paxapp.AddTestAddrs(app, ctx, 500, sdk.NewInt(10000))
...
func TestQueryValidators(t *testing.T) {
	...
	addrs := paxapp.AddTestAddrs(app, ctx, 500, app.StakingKeeper.TokensFromConsensusPower(ctx, 10000))
...
func TestQueryDelegation(t *testing.T) {
	...
	addrs := paxapp.AddTestAddrs(app, ctx, 2, app.StakingKeeper.TokensFromConsensusPower(ctx, 10000))
	addrAcc1, addrAcc2 := addrs[0], addrs[1]
	addrVal1, addrVal2 := sdk.ValAddress(addrAcc1), sdk.ValAddress(addrAcc2)

	pubKeys := paxapp.CreateTestPubKeys(2)
...
func TestQueryValidatorDelegations_Pagination(t *testing.T) {
	...
	addrs := paxapp.AddTestAddrs(app, ctx, 100, app.StakingKeeper.TokensFromConsensusPower(ctx, 10000))
	pubKeys := paxapp.CreateTestPubKeys(1)
