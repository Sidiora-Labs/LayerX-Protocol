...
func bootstrapValidatorTest(t testing.TB, power int64, numAddrs int) (*paxapp.App, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
...
func initValidators(t testing.TB, power int64, numAddrs int, powers []int64) (*paxapp.App, sdk.Context, []sdk.AccAddress, []sdk.ValAddress, []types.Validator) {
	app, ctx, addrs, valAddrs := bootstrapValidatorTest(t, power, numAddrs)
	pks := paxapp.CreateTestPubKeys(numAddrs)
