...
// EVM key prefixes — mirrored from modules/evm/types/keys.go.
...
// heavy modules/evm/types dependency (which transitively imports cosmos-sdk).
var (
...
// ParseEVMKey parses an EVM key from the modules/evm store keyspace.
//
