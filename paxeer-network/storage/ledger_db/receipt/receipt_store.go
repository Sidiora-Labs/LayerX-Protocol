...
func recoverReceiptStore(changelogPath string, db paxdbtypes.StateStore) error {
...
func startReceiptPruning(db paxdbtypes.StateStore, keepRecent int64, pruneInterval int64, stopCh <-chan struct{}, wg *sync.WaitGroup) {
