...
// Key format: modules/evm memiavl keys (mapped internally to account/code/storage DBs).
type Store interface {
	...
	// ApplyChangeSets buffers EVM changesets (modules/evm memiavl keys) and updates LtHash.
