	...
	genesisTemplate := `
{
  ...
  "codes": [
    {
      ...
      "code_info": {
        "code_hash": %q,
        "creator": "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t",
        "instantiate_config": {
          "permission": "OnlyAddress",
          "address": "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"
        }
      },
      "code_bytes": %q
    }
  ...
  "contracts": [
    {
      "contract_address": "pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un",
      "contract_info": {
        "code_id": "1",
        "creator": "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t",
        "admin": "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t",
        "label": "ȀĴnZV芢毤"
      }
    }
  ],
  ...
  {"id_key": "BGxhc3RDb250cmFjdElk", "value": "3"}
	...
	codeCreatorAddr := "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"
	...
	// verify contract
	contractAddr, _ := sdk.AccAddressFromBech32("pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un")
	gotContractInfo := keeper.GetContractInfo(ctx, contractAddr)
	require.NotNil(t, gotContractInfo)
	contractCreatorAddr := "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"
	adminAddr := "pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t"
