...
func TestInstantiate(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un", gotContractAddr.String())
...
func TestExecute(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un", addr.String())
...
func TestBuildContractAddress(t *testing.T) {
	specs := map[string]struct {
		...
		"initial contract": {
			srcCodeID:     1,
			srcInstanceID: 1,
			expectedAddr:  "pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un",
		},
		"demo value": {
			srcCodeID:     1,
			srcInstanceID: 100,
			expectedAddr:  "pax1mujpjkwhut9yjw4xueyugc02evfv46y0dtmnz4lh8xxkkdapym9sdz2cch",
		},
		"both below max": {
		...
		"codeID > max u32": {
			srcCodeID:     math.MaxUint32 + 1,
			srcInstanceID: 17,
			expectedAddr:  "pax1673hrexz4h6s0ft04l96ygq667djzh2nsr335kstjp49x5dk6rps024huf",
		},
		"instanceID > max u32": {
			srcCodeID:     22,
			srcInstanceID: math.MaxUint32 + 1,
			expectedAddr:  "pax10q3pgfvmeyy0veekgtqhxujxkhz0vm9zmalqgc7evrhj68q3l62q9nhskt",
		},
	}
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
