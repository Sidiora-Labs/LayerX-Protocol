...
func TestInstantiateProposal(t *testing.T) {
	...
	// then
	contractAddr, err := sdk.AccAddressFromBech32("pax14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9snf99un")
	require.NoError(t, err)
...
func TestUpdateInstantiateConfigProposal(t *testing.T) {
	...
	anyAddress, err := sdk.AccAddressFromBech32("pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k")
	require.NoError(t, err)
