...
func TestProposalStrings(t *testing.T) {
  ...
  Title:       Foo
  Description: Bar
  Run as:      pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
...
`,
  ...
  Description: Bar
  Run as:      pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
  Admin:       pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
  Code id:     1
  Label:       testing
  Msg:         "{\"verifier\":\"pax1qyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqsv9yg99\",\"beneficiary\":\"pax1qyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqsv9yg99\"}"
  Funds:       1foo,2bar
`,
		},
...
`,
  ...
  Title:       Foo
  Description: Bar
  Contract:    pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t
  Code id:     1
  Msg:         "{\"verifier\":\"pax1qyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqsv9yg99\"}"
`,
		},
		"update admin": {
			src: UpdateAdminProposalFixture(),
  ...
  Title:       Foo
  Description: Bar
  Contract:    pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
  New Admin:   pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t
`,
		},
		"clear admin": {
			src: ClearAdminProposalFixture(),
...
func TestProposalYaml(t *testing.T) {
	specs := map[string]struct {
		...
		"store code": {
			...
			exp: `title: Foo
description: Bar
run_as: pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
...
`,
		...
		"update admin": {
			...
			exp: `title: Foo
description: Bar
new_admin: pax1l976cvcndrr6hnuyzn93azaxx8sc2xre9m095t
contract: pax1rs8v2232uv5nw8c88ruvyjy08mmxfx25sl0l5k
`,
		},
		"clear admin": {
