...
: "${LAYERX_TESTNET_IDENTITY_URL:?LAYERX_TESTNET_IDENTITY_URL is required}"
: "${LAYERX_TESTNET_FAUCET_URL:?LAYERX_TESTNET_FAUCET_URL is required}"
: "${LAYERX_TESTNET_RECEIPT_AUTHORITY_URL:?LAYERX_TESTNET_RECEIPT_AUTHORITY_URL is required}"
: "${LAYERX_TESTNET_REGISTRY_URL:?LAYERX_TESTNET_REGISTRY_URL is required}"
: "${LAYERX_TESTNET_REDIS_URL:?LAYERX_TESTNET_REDIS_URL is required}"
