...
REQUIRES = ("fastapi>=0.110", "layerx-sdk>=0.1.0")
...
def _metadata() -> bytes:
    ...
    return (
        ...
        "Name: layerx-fastapi\n"
        f"Version: {VERSION}\n"
        "Summary: Receipt-gated x402 FastAPI integration for the LayerX protocol\n"
...
def _wheel() -> bytes:
    return (
        "Wheel-Version: 1.0\n"
        "Generator: layerx-fastapi deterministic backend 1\n"
...
def _source_files(root: Path) -> dict[str, bytes]:
    ...
    data_root = f"{NAME}-{VERSION}.data/data/share/layerx-fastapi/examples"
