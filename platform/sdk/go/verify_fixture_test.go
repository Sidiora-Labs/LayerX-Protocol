...
const programOutcomeV3Vector = ""
...
func TestProgramOutcomeV3Vector(t *testing.T) {
	...
	if err != nil { t.Fatalf("decode Programs outcome: %v", err) }
	if outcome.EncodingVersion != 3 || outcome.ABIVersion != 1 || outcome.FeeUnits != NewUint128(0, 16) { t.Fatalf("Programs outcome scalar fields diverged") }
	var callGraphRoot, terminalPayloadRoot [32]byte
	for index := range callGraphRoot { callGraphRoot[index] = 0x11; terminalPayloadRoot[index] = 0x22 }
	if outcome.CallGraphRoot != callGraphRoot || outcome.TerminalPayloadRoot != terminalPayloadRoot { t.Fatalf("Programs outcome roots diverged") }
}
