...
public enum PlatformOperation: String, CaseIterable, Sendable {
    ...
    public var descriptor: OperationDescriptor {
        ...
        case .agentProgramActivity: return OperationDescriptor(plane: .agent, name: "program.activity", method: .get, path: "/v1/programs/activities/{activity_id}", requestType: "object", responseType: "ProgramSubmission", requiresIdempotency: false, bodyless: false)
        ...
        case .agentProgramInterface: return OperationDescriptor(plane: .agent, name: "program.interface", method: .get, path: "/v1/programs/registry/{program_id}/interface", requestType: "object", responseType: "VerifiedProgramInterface", requiresIdempotency: false, bodyless: false)
        case .agentProgramReceipt: return OperationDescriptor(plane: .agent, name: "program.receipt", method: .get, path: "/v1/programs/receipts/by-idempotency/{idempotency_key}", requestType: "object", responseType: "ProgramSubmission", requiresIdempotency: false, bodyless: false)
